            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                 <a class="btn btn-box-tool btn-linkedin" onclick="addQASet()">Add Faq</a>
                </div>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              {{Form::open(array('route'=>"insertFaq"))}}
                    ...
                    <div class="panel box box-primary">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="#collapse{{$faq->id}}" class="btn btn-box-tool"   data-toggle="collapse"><i class="fa fa-plus"></i>
                                </a>
                            </div>
                        </div>
                        @endcan
                        
                        <div id="collapse{{ $faq->id }}" class="panel-collapse collapse box-body" aria-expanded="false" style="">
                            <div class="col-xs-12 no-padding">
                               @can('delete',new App\Models\Faq())
                                <a class="btn btn-danger pull-right margin-bottom" onclick="removeQASet(this,'{{ route("deleteFaq",[ "faq" => $faq->id] ) }}')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {{Form::textarea('question[]',$faq->question,['class'=>'form-control editable','required'=>'required'])}}
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                {{Form::textarea('answer[]',$faq->answer,['class'=>'form-control editable'])}}
                                </div>
                            </div>
                        </div>
                    </div>
