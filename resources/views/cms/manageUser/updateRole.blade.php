      ...
      <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {{Form::model($role,array('route'=>array('updateRole',$role->id)))}}
                <div class="card-body">
            ...
            <div class="card card-primary">
                ...
                {{Form::open(array('route'=>'assignPermission'))}}
                {{ Form::hidden('role', $role->id) }}
                <div class="card-body">
                    <div class="form-group row">
                    @foreach($permissions as $module_name=>$permission)
                    <div class="card-body col-xs-12 ">
                        <div class="card-body header col-xs-12 "><h4 style="margin: 0px 0px 10px 10px;">{{strtoupper($module_name)}}:</h4>
                            <div class="card-body col-xs-12">
                                    ...
                                    {{-- <div class=" col-lg-3 col-md-4 col-sm-6 col-xs-12"> --}}
                                        <div class="checkbox no-margin">
                                            <label title="{{ $access->description}}" class="margin-r-5">
                                                ...
                                                {{ $access->module->name."-> ".$access->access }}
                                                </label>
                                        </div>
                                    {{-- </div> --}}
                                @endforeach
