            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">categoryContent</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.col -->
            <!-- /.container-fluid -->
                            ...
                            <tbody>
                                @foreach ($contents as $content)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('editCategoryContent', ['categoryDetail' => $content->id]) }}"><i
                                                    class="fa fa-edit"></a></td>
                                        <td><a href="#"
                                                onclick="deleteItem('{{ route('deleteCategoryContent', ['categoryDetail' => $content->id]) }}')"><i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{-- @can('create', new App\Models\Permission()) --}}
                                 <a id="add"
                                    href="{{ route('createCategoryContent', ['category' => $selectedCategory, 'country' => $selectedCountry]) }}"
