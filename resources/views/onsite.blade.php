        ...
        <div class="doorstep-container">
            <form class="form" onsubmit="submitEnquiry(this)" id="contact-us">
                ...
                <div class="form-input">
                    ...
                    <input  type="hidden"  name="page" value="onsite">
                    ...
                    <div class="input-container">
                        ...
                        <input type="text" name="company" id="address" placeholder="Company Name*" autocomplete="off">
                    </div>
                    <div class="input-container">
                    ...
                    <div class="input-container">
                        ...
                        <input type="number" name="delegates" id="delegate" placeholder="Number of Delegates*"
                            autocomplete="off">
                    </div>
