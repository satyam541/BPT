            ...
            @include("layouts.navbar")
                <div class="banner-container">
                    <div class="banner-content">
                        <h1>About Us</h1>
                        <p>As a leading training provider in the industry, our main objectives are to deliver the highest standard of training to you.As a leading training provider in the industry, our main objectives are to deliver the highest standard of training to you.</p><div class="breadcrums">
