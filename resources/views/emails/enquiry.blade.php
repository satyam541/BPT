...
<body>
    <div style="width:100%">
        ...
        <div style="margin-top:10px;">
            ...
            <table style="width:100%">
                @if(!empty($enquiry->course))
                    <tr
                        style="background-color: #EFEDEE; padding: 6px; color: black; font-size: 16px; float: left; width: 100%;">
        ...
        <div style="margin-top:30px;float:left;width:100%">
            <div
                style="color:  #0063d8; padding: 6px; font-size: 20px; width: 100%; font-weight: bold; border-bottom: 2px solid #17365d;">
                What's Next?
            </div>
            <div>
                ...
                <p>
                    If you would like to speak to a learning advisor more urgently please contact <b>023 8000 1008</b>
                    or alternatively email <a
                        href="mailto:enquiries@bestpracticetraining.com">enquiries@bestpracticetraining.com</a>
                </p>
            </div>
        </div>
