...
class WebsiteDashboardController extends Controller
{
    public function index()
    {
        ...
        $data['total_enquiries']    =    Enquiry::where('country_id', cmsCountry()->country_code)->count();
        $data['total_locations']    =    Location::where('country_id', cmsCountry()->country_code)->count();
